...
namespace CSharp.Activity.Datastore
{
    ...
    public abstract class ArrayBase<T>
    {
        ...
        public virtual int IndexOf(T argToFind)
        {
            ...
            for (int i = 0; i < storeArray.Length; i++)
            {
                if (storeArray.Length.Equals(argToFind))
                {
                return i;
                }
            }
        ...
        public virtual int Add(T obj)
        {
            ...
            T[] returnArray = new T[storeArray.Length + 1];
            for (int i = 0; i < storeArray.Length; i++)
            {
                returnArray[i] = storeArray[i];
            }
            returnArray[storeArray.Length] = obj;
        ...
        public virtual void RemoveAt(int index)
        {
            ...
            for (int i = index; i < storeArray.Length - 1; i++)
            {
